...
if has("cscope")
    ...
    " 0: check cscope for definition of a symbol before checking ctags: set to 1
    ...
    "   'v'   called: find functions that function under cursor calls
    ...
    nmap <C-\>j :cs find i <C-R>=expand("%:t")<CR><CR>	
    nmap <C-\>v :cs find d <C-R>=expand("<cword>")<CR><CR>	


    " Using ';' then a search type
    " makes the vim window split horizontally, with search result displayed in
    " the new window.
    "
    " (Note: earlier versions of vim may not have the :scs command, but it
    " can be simulated roughly via:
    "    nmap ;s <C-W><C-S> :cs find s <C-R>=expand("<cword>")<CR><CR>	
...
" nmap ;f :scs find f <C-R>=expand("<cfile>")<CR><CR>	
    ...
    nmap ;j :scs find i <C-R>=expand("%:t")<CR><CR>	
    nmap ;v :scs find d <C-R>=expand("<cword>")<CR><CR>	
